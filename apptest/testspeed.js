...
async function run()
{
    document.querySelector("#messages").innerHTML = "Starting speed test...";

    const { data, error } = await supabase.functions.invoke('testspeed', {  body: 
            JSON.stringify({})
    });

    document.querySelector("#messages").innerHTML = "Speed test completed.";
}